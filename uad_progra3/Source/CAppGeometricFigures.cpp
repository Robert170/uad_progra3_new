...
void CAppGeometricFigures::render()
{
	...
	else // Otherwise, render app-specific stuff here...
	{
		...
		MathHelper::Matrix4 modelMatrix = MathHelper::SimpleModelMatrixRotationTranslation(/*(float)totalDegreesRotatedRadians*/1, m_objectPosition);
...
CVector3 CAppGeometricFigures::calePoint(CVector3 center, int numpoint, float cellsize, bool poiny)
{
	CVector3 point;
