...
void CAppCubeTest::render()
{
	...
	MathHelper::Matrix4 viewM = MathHelper::ViewMatrix( //se puede dejar como variable de clase
	...
	MathHelper::Matrix4 projM = MathHelper::PerspectiveProjectionMatrix( //se puede dejar como variable de clase
