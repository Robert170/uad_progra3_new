...
// --------------------------------------------------------------------------------------------------------------------------------------
class CAppSphere_Taroide : public CApp
{
private:
	...
	float nx, ny, nz, lengthInv, radius=50;    // vertex normal
	float s, t;                                     // vertex texCoord
	float sectorStep, sectorCount=20;
	float stackStep, stackCount=20;
...
public:
	...
	CAppSphere_Taroide();
	CAppSphere_Taroide(int window_width, int window_height);
	~CAppSphere_Taroide();
